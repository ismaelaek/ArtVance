...
function PrivacyPolicy() {
    ...
    return (
        <main className="bg-gradient-to-br from-purple-200 via-pink-200 to-yellow-100 flex items-center justify-center min-h-screen p-5">
            <div className="p-8 font-sans bg-white shadow-lg rounded-lg  ">
            <div className="bg-purple-700 rounded-b-full text-center mb-20 p-20">
                ...
                <div className="flex flex-col md:flex-row">
                    ...
                    <div className="w-full md:w-3/4">
                        <div id="introduction" className="mb-8">
                            <h2 className="text-3xl font-semibold mb-4 text-purple-700"><InfoCircleOutlined className="mr-2" />Introduction</h2>
                        ...
                        <div id="informationCollection" className="mb-8">
                            <h2 className="text-3xl font-semibold mb-4 text-purple-700"><UserOutlined className="mr-2" />Information Collection</h2>
                        ...
                        <div id="informationUse" className="mb-8">
                            <h2 className="text-3xl font-semibold mb-4 text-purple-700"><SolutionOutlined className="mr-2" />Information Use</h2>
                        ...
                        <div id="informationSharing" className="mb-8">
                            <h2 className="text-3xl font-semibold mb-4 text-purple-700"><SafetyOutlined className="mr-2" />Information Sharing</h2>
                        ...
                        <div id="security" className="mb-8">
                            <h2 className="text-3xl font-semibold mb-4 text-purple-700"><SafetyCertificateOutlined className="mr-2" />Security</h2>
                        ...
                        <div id="yourRights" className="mb-8">
                            <h2 className="text-3xl font-semibold mb-4 text-purple-700"><LockOutlined className="mr-2" />Your Rights</h2>
                        ...
                        <div id="changePassword" className="mb-8">
                            <h2 className="text-3xl font-semibold mb-4 text-purple-700">Change Password</h2>
                            ...
                            <Button type="primary" icon={<LockOutlined />} onClick={showModal} className='bg-purple-500 mt-4'>
                                Change Password
                            </Button>
                        </div>
                        <div id="contactUs" className="mb-8">
                            <h2 className="text-3xl font-semibold mb-4 text-purple-700"><PhoneOutlined className="mr-2" />Contact Us</h2>
                            <p className="text-gray-700">If you have any questions about this Privacy Policy, please contact us at:</p>
                            <p className="text-gray-700 mt-2">Email: <a href="mailto:support@yourapp.com" className="text-purple-500 hover:underline">support@yourapp.com</a></p>
                        </div>
                        <div className="text-right mt-8 ">
                            <p className="text-gray-700 italic">Made with <span className="text-pink-300">♥</span> by the Art Viens Team</p>
                        </div>
                    </div>
                </div>
            </div>
